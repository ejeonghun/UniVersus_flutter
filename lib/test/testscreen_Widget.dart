                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  // context.pushNamed('detailjungmo');
                                },
                                text: '정모 자세히보기',
                                options: FFButtonOptions(
                                  height: 40,
                          ...
                          children: [
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  Navigator.of(context)
                                      .pushNamed('/UnivBattleRecordPage');
                                },
                                text: '승패',
                                options: FFButtonOptions(
                                  height: 40,
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  Navigator.of(context).push(
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          AdditionalInfoWidget(emailData: {
                                        'email': 'wjdgns4019@g.yju.ac.kr',
                                        'university': '영진전문대학교',
                                        'univId': "214"
                                      }),
                                    ),
