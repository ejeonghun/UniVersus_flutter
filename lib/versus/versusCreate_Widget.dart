...
import 'versusCreate_Model.dart';
export 'versusCreate_Model.dart';

class versusCreateWidget extends StatefulWidget {
  const versusCreateWidget({super.key});

  @override
  State<versusCreateWidget> createState() => _versusCreateWidgetState();
}

class _versusCreateWidgetState extends State<versusCreateWidget> {
  late versusCreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => versusCreateModel());

    _model.versusPriceController ??= TextEditingController();
    _model.versusPriceFocusNode ??= FocusNode();

    _model.versusIntroController ??= TextEditingController();
    _model.versusIntroFocusNode ??= FocusNode();
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FlutterFlowRadioButton(
                                options: ['대학 vs 대학', '학과 vs 학과'].toList(),
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          controller: _model.versusPriceController,
                          focusNode: _model.versusPriceFocusNode,
                          ...
                          validator: _model.versusPriceControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      Padding(
                        ...
                        child: TextFormField(
                          controller: _model.versusIntroController,
                          focusNode: _model.versusIntroFocusNode,
                          ...
                          maxLines: 3,
                          minLines: null,
                          validator: _model.versusIntroControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      Padding(
                        ...
                        child: Text(
                          '각 팀 인원수 ${_model.countControllerValue}/20',
                          style:
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              if (!await _model.inputCheck(context)) {
                                return;
                              }
