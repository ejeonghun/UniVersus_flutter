...
import 'deptVersusCheck_Model.dart';
export 'deptVersusCheck_Model.dart';

class deptVersusCheckWidget extends StatefulWidget {
  final int battleId;
  const deptVersusCheckWidget({super.key, required this.battleId});

  @override
  State<deptVersusCheckWidget> createState() => _CheckVersusWidgetState();
}

class _CheckVersusWidgetState extends State<deptVersusCheckWidget> {
