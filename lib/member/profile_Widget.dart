        ...
        body: FutureBuilder(
            ...
            builder:
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                nickname = snapshot.data!.getNickname;
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Image.network(
                                        'https://raw.githubusercontent.com/ejeonghun/university_dept_api/main/img/png/PNG_221.png',
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ),
                        ...
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) => PasswordChangeWidget(
                                  email: userName!, memberIdx: memberIdx!)));
                          debugPrint('비밀번호 변경');
                        },
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  if (await UserData.deleteUser() == true) {
                                    Navigator.of(context)
                                        .pushNamedAndRemoveUntil(
                                            '/login', (route) => false);
                                    CustomSnackbar.success(
                                        context, "성공", "로그아웃에 성공했습니다.", 3);
                                  }
                                },
                                text: '로그아웃',
